...
def analyze_document_text(text: str) -> dict:
    ...
    system_instruction = (
        ...
        "   - 'names': List of all people names or generic human groups found.\n"
        "   - 'dates': List of key dates found.\n"
        "   - 'organizations': List of all companies, institutions, and generic entity groups found (e.g., 'governments', 'universities', 'private companies', 'Google', etc.). Extract every possible entity even if it's a broad generic category.\n"
