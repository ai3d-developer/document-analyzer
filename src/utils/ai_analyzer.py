...
def analyze_document_text(text: str) -> dict:
    ...
    system_instruction = (
        ...
        "   - 'organizations': List all organization names, company names, institutions, and organizational groups physically mentioned in the text (e.g., 'financial institutions', 'regional banks', 'government agencies', 'Google', etc.). Do NOT hallucinate names that are not in the document.\n"
